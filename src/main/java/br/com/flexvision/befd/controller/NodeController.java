...
import br.com.flexvision.befd.flex4.service.NodeService;

@Controller
@CrossOrigin(origins = "*")
@RequestMapping("node")
public class NodeController extends MainController{

	@Autowired
	private NodeService service; 
	
	@RequestMapping(value="/listNodes", method=RequestMethod.POST, produces=MediaType.APPLICATION_JSON)
